              ...
              onPressed: () {
                showDialog<Null>(
                  ...
                  builder: (BuildContext context) {
                    return CustomAlertDialog(title: "Confirmation Required", content: "Do you want to save changes to profile?",yesOnPressed: saveMeal, noOnPressed: cancel);
                  },
                );
              },
            )
                                                  ...
                                                  return Container(
                                                      ...
                                                      child: Column(
                                                        children: <Widget>[
                                                          ...
                                                          Center(child: Text(ingredients[index],
                                                            style: TextStyle(
                                                                color: Colors.white,
                                                                fontSize: 24.0,
